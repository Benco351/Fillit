...
const getUsers = (_req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger_1.logger.error(`getUsers error: ${err}`);
        next(err);
    }
});
...
const createUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger_1.logger.info(`Created user ${user.id}`);
        res.status(201).json((0, apiResponse_1.apiResponse)(user, 'User created'));
    }
    catch (err) {
        logger_1.logger.error(`createUser error: ${err}`);
        next(err);
    }
});
